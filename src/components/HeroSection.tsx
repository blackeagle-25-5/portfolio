...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center pt-20 relative overflow-hidden bg-[#16171b]">
      ...
      <div className="absolute inset-0 z-0 flex justify-center items-end">
        <motion.div
          ...
          className="relative w-full max-w-[500px] h-[85vh]"
        >
      ...
      <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
        ...
        <div className="lg:col-span-5 flex flex-col justify-center order-2 lg:order-1 relative z-20 mix-blend-difference md:mix-blend-normal">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight drop-shadow-lg">
              I'm {hero.name.split(' ')[0]}, a<br />{hero.role.split(' ')[0]} {hero.role.split(' ')[2] || 'Developer'}
            </h1>
            <p className="text-gray-300 text-sm mb-12 leading-relaxed max-w-sm drop-shadow-md">
        ...
        {/* Right Column */}
        <div className="lg:col-span-4 flex flex-col justify-center space-y-12 order-3 relative z-20 lg:pl-12">
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }}
          >
            <h3 className="text-sm font-bold text-white tracking-widest uppercase mb-4 drop-shadow-md">About Me</h3>
            <p className="text-gray-400 text-sm mb-4 leading-relaxed drop-shadow-md">
              I am an engineering student and developer passionate about building scalable web applications.
            </p>
            <Link href="#about" className="text-white text-xs font-bold tracking-widest uppercase hover:text-[#0d6efd] transition-colors flex items-center gap-2 drop-shadow-md">
